...
# Cpyher generation prompt (refer to Github GraphCypherQAChain in qa_prompt)
...
# refer to Github GraphCypherQAChain in langchain chain qa_prompt
...
# Build simply UI chatbot with streamlit
...
with title_col:
    st.title("Converational Neo4J Assistant")
with img_col:
    st.image("https://dist.neo4j.com/wp-content/uploads/20210423062553/neo4j-social-share-21.png", width=200)

user_input = st.text_input("What do you want to lookup today?", key = "input")
if user_input:
    ...
    # split chunks into three type of answer
    col1, col2, col3 = st.columns([1, 1, 1])

    # Col1 = Display the chat history
    with col1:
